		...
		addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(result == 1) {
					...
					JOptionPane.showMessageDialog(null, "Black Win", "Winner", JOptionPane.PLAIN_MESSAGE);
				}else if(result == 2) {
					JOptionPane.showMessageDialog(null, "White Win", "Winner", JOptionPane.PLAIN_MESSAGE);
